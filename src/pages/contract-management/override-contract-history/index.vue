...
export default {
    ...
    data() {
        return {
            ...
            options: [
                ...
                { value: "override_approved_by_co_sourcing", name: "Approved by Co Sourcing" },
                { value: "override_rejected_by_co_sourcing", name: "Rejected by Co Sourcing" },
                // { value: "override_rejected_by_vendor", name: "Rejected by Vendor" },
    ...
    created() {
        if (!this.$lodash.isEmpty(this.$router.currentRoute.query)) {
            ...
            if (this.isCoorporateSourcingTeam) this.status = "override";
        }
        ...
        getQuery() {
            const query = {
                ...
                include: [
                    ...
                    { model: "ContractCategory", include: [{ model: "MstCategory", attributes: ["name"] }] },
                ],
            };
        ...
        v-app.custom-shadow.contract-history
            ...
            div.ismobile
                ul.flex-content(v-for="item of items")
                    ...
                    li.flex-item(data-label='Status') {{ item.overrideStatus | humanize }}
